...
INSERT OR IGNORE INTO customers (id_customer_type, business_name, [name], surname, phone, email, vat_number, [address], city, country) VALUES
(1, 'Tech Solutions SRL', NULL, NULL, '+39 0277889923', 'info@techsolutions.it', 'IT12345678901', 'Via Roma 10', 'Milano', 'Italia'),
(3, NULL, 'Giovanni', 'Verdi', '+39 0611223334', 'giovanniverdi@gmail.it', 'VRDGVN85M01H501X', 'Piazza Navona 5', 'Roma', 'Italia'),
(2, 'Comune di Firenze', NULL, NULL, '+39 0551234567', 'firenze@comune.it', 'IT98765432109', 'Piazza della Signoria 1', 'Firenze', 'Italia'),
(3, NULL, 'Luca', 'Verdi', '+39 3331234267', 'luca.verdi@gmail.com', 'VRDLCU90A01F205X', 'Via Milano 5', 'Torino', 'Italia');
...
(1, 1, 'HW-001', '8001234567890', 'Notebook Business 14"', 10, 22, 899.00),
(2, 1, 'SW-001', NULL, 'Licenza Software Gestionale', 100, 22, 250.00),
(3, 1, 'SRV-001', NULL, 'Installazione e configurazione', 0, 22, 120.00);
